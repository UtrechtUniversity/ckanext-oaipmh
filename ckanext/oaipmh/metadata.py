...
datacite_ilabfields = {
         ...
         'version':           ('textList', 'datacite:resource/datacite:version/text()'),
         'language':          ('textList', 'datacite:resource/datacite:language/text()'),
         'funderName':        ('textList', 'datacite:resource/datacite:fundingReferences/datacite:fundingReference/datacite:funderName/text()'),
         'awardNumber':       ('textList', 'datacite:resource/datacite:fundingReferences/datacite:fundingReference/datacite:awardNumber/text()'),
...
datacite_fields = {
        ...
        'version':           ('textList', 'default:resource/default:version/text()'),
        'language':          ('textList', 'default:resource/default:language/text()'),
        'funderName':        ('textList', 'default:resource/default:fundingReferences/default:fundingReference/default:funderName/text()'),
        'awardNumber':       ('textList', 'default:resource/default:fundingReferences/default:fundingReference/default:awardNumber/text()'),
